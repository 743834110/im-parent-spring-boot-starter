...
public class ChatReqHandler extends org.jim.server.command.handler.ChatReqHandler {
     ...
     */
    private Map<String, IChatService> chatServiceMap = new HashMap<String, IChatService>() {
        {
            this.put("text", new TextChatServiceImpl());
            this.put("file", new DefaultFileChatServiceImpl());
        }
        ...
        public IChatService get(Object key) {
            ...
            return chatService == null? super.get("file"): chatService;
        }
    };
    ...
    public ImPacket handler(ImPacket packet, ChannelContext channelContext) throws Exception {
        ...
        String messageType = chatBody.getMsgType();
